...
$(function(){
    $('#profile_form').validate({
        ...
        messages : {
            portrait  : {
                accept   : 'Supporta gif、jpeg、jpg、png immagini'
            }
        }
    });
                    ...
                    <div class="information">
                        ...
                        <div class="info individual">
                            <table>
                                ...
                                <tr>
                                    <th>Nome:</th>
                                    <td><input type="text" name="real_name" value="<?php echo htmlspecialchars($this->_var['profile']['real_name']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>Sesso: </th>
                                    <td class="label">
                                        <label>
                                           <input type="radio" name="gender" value="0" <?php if ($this->_var['profile']['gender'] == 0): ?>checked="checked"<?php endif; ?> />Privacy  </label>
                                            <label>
                                            <input type="radio" name="gender" value="1" <?php if ($this->_var['profile']['gender'] == 1): ?>checked="checked"<?php endif; ?> />Maschile   </label>
                                            <label>
                                            <input type="radio" name="gender" value="2" <?php if ($this->_var['profile']['gender'] == 2): ?>checked="checked"<?php endif; ?> />Feminile </label>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Data di nascita: </th>
                                    <td>
                                        <input type="text" name="birthday" id="birthday" value="<?php echo $this->_var['profile']['birthday']; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>QQ:</th>
                                    <td> <input type="text" name="im_qq" value="<?php echo htmlspecialchars($this->_var['profile']['im_qq']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>MSN:</th>
                                    <td><input type="text" name="im_msn" value="<?php echo htmlspecialchars($this->_var['profile']['im_msn']); ?>" />               </td>
                                </tr>
                                <?php if ($this->_var['edit_avatar']): ?>
                                <tr>
                                    <th>头像:</th>
