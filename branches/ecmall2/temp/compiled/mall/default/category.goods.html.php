...
<div class="content">
    <div class="commodity_assort">
        <div class="module_sidebar">
            <h2><b class="category" title="CATEGORYCategorie di oggetti"></b></h2>
            <div class="wrap">
...
?>
                            <dt class="bg_color1"><a href="index.php?app=search&cate_id=<?php echo $this->_var['gcategory']['id']; ?>"><?php echo htmlspecialchars($this->_var['gcategory']['value']); ?></a></dt>
                            <dd>
