...
?>
                        <li>
                            <div class="pic"><a href="index.php?app=store&id=<?php echo $this->_var['store']['store_id']; ?>" target="_blank"><img src="<?php echo $this->_var['store']['store_logo']; ?>" width="65" height="65" /></a></div>
                            <dl>
                                <dt><a href="index.php?app=store&id=<?php echo $this->_var['store']['store_id']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['store']['store_name']); ?></a></dt>
...
?>
    ...
    <div class="right">
        <div class="module_sidebar">
            <h2><b class="gategory" title="CATEGORYCategorie di negozio"></b></h2>
            <div class="wrap">
                <div class="wrap_child">
                    <div class="recommend">
...
?>
                                <a href="index.php?app=search&act=store&cate_id=<?php echo $this->_var['child']['id']; ?>"><?php echo htmlspecialchars($this->_var['child']['value']); ?></a>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </dd>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </dl>
