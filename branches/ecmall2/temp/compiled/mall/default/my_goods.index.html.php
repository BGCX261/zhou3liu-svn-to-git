                ...
                <table id="my_goods" server="<?php echo $this->_var['site_url']; ?>/index.php?app=my_goods&amp;act=ajax_col" >
                    ...
                    <tr class="line_bold">
                        ...
                        <th colspan="8">
                            ...
                            <a class="detlink" style="float:right" href="index.php?app=my_goods">取消检索</a>
                            <?php endif; ?>
                    ...
                    <tr class="gray"  ectype="table_header">
                        <th width="30"></th>
                        <th width="55"></th>
                        <th width="185" coltype="editable" column="goods_name" checker="check_required" inputwidth="90%" title="排序"  class="cursor_pointer"><span ectype="order_by">商品名称</span></th>
                        <th width="70" column="cate_id" title="排序"  class="cursor_pointer"><span ectype="order_by">商品分类</span></th>
                        <th width="60" coltype="editable" column="brand" checker="check_required" inputwidth="55px" title="排序"  class="cursor_pointer"><span ectype="order_by">品牌</span></th>
                        <th width="60" class="cursor_pointer" coltype="editable" column="price" checker="check_number" inputwidth="50px" title="排序"><span ectype="order_by">价格</span></th>
                        <th width="60" class="cursor_pointer" coltype="editable" column="stock" checker="check_pint" inputwidth="50px" title="排序"><span ectype="order_by">库存</span></th>
                        <th width="35" coltype="switchable" column="if_show" onclass="right_ico" offclass="wrong_ico" checker="" title="排序"  class="cursor_pointer"><span ectype="order_by">上架</span></th>
                        <th width="35" coltype="switchable" column="recommended" onclass="right_ico" offclass="wrong_ico" checker="" title="排序"  class="cursor_pointer"><span ectype="order_by">推荐</span></th>
                        <th width="35" column="closed" title="排序" class="cursor_pointer"><span ectype="order_by">禁售</span></th>
                        <th>操作</th>
                    </tr>
                    <?php endif; ?>
...
?>
                    <tr class="line<?php if (($this->_foreach['_goods_f']['iteration'] == $this->_foreach['_goods_f']['total'])): ?> last_line<?php endif; ?>" ectype="table_item" idvalue="<?php echo $this->_var['goods']['goods_id']; ?>">
                        ...
                        <td width="50" class="align2"><a href="index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['goods']['default_image']; ?>" width="50" height="50"  /></a></td>
                        <td width="180" align="align2">
                        ...
                        <td width="55" class="align2"><span class="color2" ectype="editobj"><?php echo htmlspecialchars($this->_var['goods']['brand']); ?></span></td>
                        ...
                        <td width="30" class="align2"><span style="margin:0px 5px;" ectype="editobj" <?php if ($this->_var['goods']['if_show']): ?>class="right_ico" status="on"<?php else: ?>class="wrong_ico" stauts="off"<?php endif; ?>></span></td>
                        <td width="30" class="align2"><span style="margin:0px 5px;" ectype="editobj" <?php if ($this->_var['goods']['recommended']): ?>class="right_ico" status="on"<?php else: ?>class="wrong_ico" stauts="off"<?php endif; ?>></span></td>
                        <td width="30" class="align2"><span style="margin:0px 5px;" <?php if ($this->_var['goods']['closed']): ?>class="no_ico"<?php else: ?>class="no_ico_disable"<?php endif; ?>></span></td>
                        <td><div><a href="index.php?app=my_goods&amp;act=edit&id=<?php echo $this->_var['goods']['goods_id']; ?>" class="edit">编辑</a> <a href="javascript:drop_confirm('您确定要删除它吗？', 'index.php?app=my_goods&amp;act=drop&id=<?php echo $this->_var['goods']['goods_id']; ?>');" class="delete">删除</a></div></td>
                    </tr>
                    <?php endforeach; else: ?>
                    <tr>
