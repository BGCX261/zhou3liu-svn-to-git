...
?>
                <tr>
                    <td><a <?php if ($this->_var['article']['link']): ?>target="_blank"<?php endif; ?> href="index.php?app=article&amp;act=view&article_id=<?php echo $this->_var['article']['article_id']; ?>" class="lebioa"><?php echo htmlspecialchars($this->_var['article']['title']); ?></a></td>
