                        ...
                        <div class="add_spec" ectype="dialog_contents" style="display: none">
                            ...
                            <div class="table" ectype="spec_editor">
                                ...
                                <ul class="td" ectype="spec_item">
                                    ...
                                    <li><input item="sku" type="text" class="text width8" /></li>
                                    <li class="padding3">
...
?>
                            ...
                            <div class="products">
                                <ul>
                                    <li>
                                        <h2>商品名称：</h2>
                                        <div class="arrange"><input title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" type="text" name="goods_name" value="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" class="text width7" /><span class="red">*</span></div>
                                    </li>
                                    <li>
                                        <h2>品牌：</h2>
                                        <div class="arrange"><input type="text" name="brand" value="<?php echo htmlspecialchars($this->_var['goods']['brand']); ?>" class="text" /></div>
                                    </li>
                                    <li>
                                        <h2  ectype="no_spec">价格：</h2>
                                        <div class="arrange"  ectype="no_spec"><input name="price" value="<?php echo $this->_var['goods']['_specs']['0']['price']; ?>" type="text" class="text width2" /></div>
                                    </li>
                                    <li ectype="no_spec">
                                        <h2>库存：</h2>
                                        <div class="arrange"><input name="stock" value="<?php echo $this->_var['goods']['_specs']['0']['stock']; ?>" type="text" class="text width2" /></div>
                                    </li>
                                    <li ectype="no_spec">
                                        <h2>货号：</h2>
                                        <div class="arrange"><input name="sku" value="<?php echo $this->_var['goods']['_specs']['0']['sku']; ?>" type="text" class="text" /></div>
                                    </li>
                                    <li>
                                        <h2>规格：</h2>
                                        <div class="arrange">
...
?>
                                        <li ectype="handle_pic" file_name="<?php echo $this->_var['desc_image']['file_name']; ?>" file_path="<?php echo $this->_var['desc_image']['file_path']; ?>" file_id="<?php echo $this->_var['desc_image']['file_id']; ?>">
                                        <input type="hidden" name="desc_file_id[]" value="<?php echo $this->_var['desc_image']['file_id']; ?>">
                                            <div class="pic">
                                            <img src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['desc_image']['file_path']; ?>" width="50" height="50" alt="<?php echo $this->_var['desc_image']['file_name']; ?>" title="<?php echo $this->_var['desc_image']['file_name']; ?>" /></div>
                                            <div ectype="handler" class="bg">
                                            <img src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['desc_image']['file_path']; ?>" width="50" height="50" alt="<?php echo $this->_var['desc_image']['file_name']; ?>" title="<?php echo $this->_var['desc_image']['file_name']; ?>" />
                                                <p class="operation">
                                                    <a class="cut_in" ectype="insert_editor" href="###" ecm_title="插入编辑器"></a>
                                                    <span class="delete" ectype="drop_image" ecm_title="删除"></span>
                                                </p>
                                                <p title="<?php echo $this->_var['desc_image']['file_name']; ?>" class="name"><?php echo $this->_var['desc_image']['file_name']; ?></p>
                                            </div>
                                        </li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
