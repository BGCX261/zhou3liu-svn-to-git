...
?>
    <dl class="<?php echo $this->cycle(array('values'=>'message_text,message_text bg1')); ?>">
        <dt>
            <span class="light"><?php if ($this->_var['comment']['anonymous']): ?>***<?php else: ?><?php echo $this->_var['comment']['buyer_name']; ?><?php endif; ?> (<?php echo local_date("Y-m-d H:i:s",$this->_var['comment']['evaluation_time']); ?>)</span>
        </dt>
        <dd><?php echo nl2br($this->_var['comment']['comment']); ?></dd>
        <div class="beat">
            Valutazione:
    ...
    <dl class="message_text">
        <dt><span class="light">No oggetti trovati</span></dt>
    </dl>
