...
<div id="content">
    ...
    <div id="right">
        ...
        <ul class="user_menu">
            <div class="ornament1"></div>
            <div class="ornament2"></div>
            <li><a class="<?php if ($_GET['eval']): ?>normal<?php else: ?>active<?php endif; ?>" href="index.php?app=store&amp;act=credit&amp;id=<?php echo $this->_var['store']['store_id']; ?>"><span>全部评价</span></a></li>
            <li><a class="<?php if ($_GET['eval'] == 3): ?>active<?php else: ?>normal<?php endif; ?>" href="index.php?app=store&amp;act=credit&amp;id=<?php echo $this->_var['store']['store_id']; ?>&amp;eval=3"><span>好评</span></a></li>
            <li><a class="<?php if ($_GET['eval'] == 2): ?>active<?php else: ?>normal<?php endif; ?>" href="index.php?app=store&amp;act=credit&amp;id=<?php echo $this->_var['store']['store_id']; ?>&amp;eval=2"><span>中评</span></a></li>
            <li><a class="<?php if ($_GET['eval'] == 1): ?>active<?php else: ?>normal<?php endif; ?>" href="index.php?app=store&amp;act=credit&amp;id=<?php echo $this->_var['store']['store_id']; ?>&amp;eval=1"><span>差评</span></a></li>
        </ul>
...
?>
            <tr>
                ...
                <td><a class="ware_link" href="index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a></td>
