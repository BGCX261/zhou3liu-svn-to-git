    ...
    <div id="right">
        <div class="module_special">
            <h2 class="common_title veins2">
                ...
                <span class="ico1"><span class="ico2"><?php echo $this->_var['search_name']; ?></span></span>
            </h2>
            <div class="wrap">
...
?>
                            <li>
                                <div class="pic"><a href="index.php?app=goods&amp;id=<?php echo $this->_var['sgoods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['sgoods']['default_image']; ?>" width="150" height="150" /></a></div>
                                <h3><a href="index.php?app=goods&amp;id=<?php echo $this->_var['sgoods']['goods_id']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['sgoods']['goods_name']); ?></a></h3>
