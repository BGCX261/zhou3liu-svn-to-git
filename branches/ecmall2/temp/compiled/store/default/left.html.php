        <div class="user">
            <div class="user_photo">
                ...
                <div class="photo"><a href="index.php?app=store&amp;id=<?php echo $this->_var['store']['store_id']; ?>"><img src="<?php echo $this->_var['store']['store_logo']; ?>" width="100" height="100" /></a></div>
                <p><a href="javascript:collect_store(<?php echo $this->_var['store']['store_id']; ?>)">Aggiungi ai Negozi preferiti</a></p>
            </div>
            
            <div class="user_data">
                <p>
                    <span>Venditore: </span><?php echo htmlspecialchars($this->_var['store']['store_owner']['user_name']); ?>
                    <a target="_blank" href="index.php?app=message&act=send&to_id=<?php echo htmlspecialchars($this->_var['store']['store_owner']['user_id']); ?>"><img src="<?php echo $this->res_base . "/" . 'images/web_mail.gif'; ?>" alt="Mandi messagi" /></a>
                </p>
                <p>
                    <span>Credit: </span><span class="fontColor1"><?php echo $this->_var['store']['credit_value']; ?></span>
                    <?php if ($this->_var['store']['credit_value'] >= 0): ?><img src="<?php echo $this->_var['store']['credit_image']; ?>" alt="" /><?php endif; ?>
                </p>
                <p>Grado del negozio: <?php echo $this->_var['store']['sgrade']; ?></p>
                <p>Quantità: <?php echo $this->_var['store']['goods_count']; ?></p>
                <p>regione: <?php echo htmlspecialchars($this->_var['store']['region_name']); ?></p>
                <p>Negozio dal: <?php echo local_date("Y-m-d",$this->_var['store']['add_time']); ?></p>
...
?>
                        ...
                        <a href="index.php?app=article&amp;act=system&amp;code=cert_autonym" target="_blank" title="Autenticazione di nome"><img src="<?php echo $this->res_base . "/" . 'images/cert_autonym.gif'; ?>" /></a>
                        <?php elseif ($this->_var['cert'] == "material"): ?>
                        <a href="index.php?app=article&amp;act=system&amp;code=cert_material" target="_blank" title="Enti negozi"><img src="<?php echo $this->res_base . "/" . 'images/cert_material.gif'; ?>" /></a>
                        <?php endif; ?>
                ...
                <p>Indirizzo: <?php echo htmlspecialchars($this->_var['store']['address']); ?></p>
                <?php endif; ?>
                <?php if ($this->_var['store']['tel']): ?>
                <p>Numero di telefono: <?php echo htmlspecialchars($this->_var['store']['tel']); ?></p>
                <?php endif; ?>
                <p>
        ...
        <div class="module_common">
            <h2 class="common_title veins1">
                ...
                <span class="ico1"><span class="ico2">Cerca nel negozio</span></span>
            </h2>
            <div class="wrap">
        ...
        <div class="module_common">
            <h2 class="common_title veins1">
                <div class="ornament1"></div>
                <div class="ornament2"></div>
                <span class="ico1"><span class="ico2">Categorie di oggetti</span></span>
            </h2>
            <div class="wrap">
                <div class="wrap_child">
                    <ul class="submenu">
                        <li><a class="none_ico" href="index.php?app=store&amp;id=<?php echo $this->_var['store']['store_id']; ?>&amp;act=search">Tutti oggetti</a></li>
...
?>
                        ...
                        <li>
                            <a class="block_ico" href="index.php?app=store&amp;id=<?php echo $this->_var['store']['store_id']; ?>&amp;act=search&amp;cate_id=<?php echo $this->_var['gcategory']['id']; ?>"><?php echo htmlspecialchars($this->_var['gcategory']['value']); ?></a>
                            <ul>
...
?>
                                <li><a href="index.php?app=store&amp;id=<?php echo $this->_var['store']['store_id']; ?>&amp;act=search&amp;cate_id=<?php echo $this->_var['child_gcategory']['id']; ?>"><?php echo htmlspecialchars($this->_var['child_gcategory']['value']); ?></a></li>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            </ul>
                        </li>
                        <?php else: ?>
                        <li><a class="none_ico" href="index.php?app=store&amp;id=<?php echo $this->_var['store']['store_id']; ?>&amp;act=search&amp;cate_id=<?php echo $this->_var['gcategory']['id']; ?>"><?php echo htmlspecialchars($this->_var['gcategory']['value']); ?></a></li>
                        <?php endif; ?>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                </div>
...
?>
        ...
        <div class="module_common">
            <h2 class="common_title veins1">
                <div class="ornament1"></div>
                <div class="ornament2"></div>
                <span class="ico1"><span class="ico2">Le mie attività recenti</span></span>
            </h2>
            <div class="wrap">
                <div class="wrap_child">
                    <ul class="annals">
...
?>
                        <li><a href="index.php?app=goods&amp;id=<?php echo $this->_var['gh_goods']['goods_id']; ?>"><img src="<?php echo $this->_var['gh_goods']['default_image']; ?>" width="50" height="50" alt="<?php echo htmlspecialchars(sub_str($this->_var['gh_goods']['goods_name'],20)); ?>" title="<?php echo htmlspecialchars($this->_var['gh_goods']['goods_name']); ?>" /></a></li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                </div>
            </div>
