<div id="nav">
    ...
    <ul>
        <li><a class="<?php if ($_GET['app'] == 'store' && $_GET['act'] == 'index'): ?>active<?php else: ?>normal<?php endif; ?>" href="index.php?app=store&amp;id=<?php echo $this->_var['store']['store_id']; ?>"><span>Home del negozio</span></a></li>
...
?>
        ...
        <li><a class="<?php if ($_GET['app'] == 'store' && $_GET['act'] == 'credit'): ?>active<?php else: ?>normal<?php endif; ?>" href="index.php?app=store&amp;act=credit&amp;id=<?php echo $this->_var['store']['store_id']; ?>"><span>Feedback</span></a></li>
        <a class="collection" href="javascript:collect_store(<?php echo $this->_var['store']['store_id']; ?>)">Aggiungi ai Negozi preferiti</a>
    </ul>
