...
/*TODO 换语言 */
function chglang(mylang)
{
    //var url=SITE_URL+'/index.php?app=my_favorite&act=chglang&jsoncallback=?&ajax=1';
    $.setCookie('my_language',mylang);
    //alert('languae changed to ' + mylang);
