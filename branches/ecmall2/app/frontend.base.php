...
//        $this->_view->res_base     = SITE_URL . "/themes/store/{$template_name}/styles/{$style_name}";
        //LLL让店铺模板也随语言变化而变化
        $this->_view->template_dir = ROOT_PATH . "/themes/store/{$GLOBALS['ECMALL_CONFIG']['template_name']}";//$template_name}";
        $this->_view->compile_dir  = ROOT_PATH . "/temp/compiled/store/{$GLOBALS['ECMALL_CONFIG']['template_name']}";
        $this->_view->res_base     = SITE_URL . "/themes/store/{$GLOBALS['ECMALL_CONFIG']['template_name']}/styles/{$style_name}";
    }
