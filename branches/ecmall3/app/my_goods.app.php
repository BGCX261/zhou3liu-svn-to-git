...
class My_goodsApp extends StoreadminbaseApp
{
   ...
   function ajax_col()
   {
    ...
    function export()
    {
        ...
        $rows[] = array('goods_name', 'brand', 'price', 'stock', 'sku', 'description', 'default_image');
        foreach ($goods_list as $goods)
        {
            $rows[] = array($goods['goods_name'], $goods['brand'], $goods['price'], $goods['stock'], $goods['sku'], $goods['description'], $goods['default_image']);
        }
