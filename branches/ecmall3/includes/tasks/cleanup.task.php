...
class CleanupTask extends BaseTask
{
    ...
    function _close_expired_store()
    {
        ...
        $content = sprintf(Lang::get('your_store_is_closed'), Lang::get('close_reason'));
        ...
        /* 发送邮件 */
        $this->_mailto($store_emails, $subject, $content);
        $ms->pm->send(MSG_SYSTEM, $store_ids, $subject, $content);
        $store_mod->edit($store_ids, array('state' => STORE_CLOSED, 'close_reason' => Lang::get('close_reason')));
    }
}
