...
EOT;
    ...
    function _format_page(&$page, $num = 7)
    {
        ...
        $page['next_link'] = $page['curr_page'] < $to ? "{$url_format}&amp;page=" . ($page['curr_page'] + 1) : "";//echo '<pre>',var_dump($page);
    }
...
class BaseVisitor extends Object
{
    ...
    function _get_detail()
    {
        ...
        $member_info = $model_member->findAll(array(
            ...
            'fields'        => 'email, password, real_name, logins, ugrade, portrait, store_id, state',
