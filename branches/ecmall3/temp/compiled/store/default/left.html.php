        <div class="user">
            ...
            <div class="user_data">
                <p>
                    ...
                    <a target="_blank" href="index.php?app=message&act=send&to_id=<?php echo htmlspecialchars($this->_var['store']['store_owner']['user_id']); ?>"><img src="<?php echo $this->res_base . "/" . 'images/web_mail.gif'; ?>" alt="发站内信" /></a>
                </p>
                <p>
...
?>
                        ...
                        <a href="index.php?app=article&amp;act=system&amp;code=cert_autonym" target="_blank" title="实名认证"><img src="<?php echo $this->res_base . "/" . 'images/cert_autonym.gif'; ?>" /></a>
                        <?php elseif ($this->_var['cert'] == "material"): ?>
                        <a href="index.php?app=article&amp;act=system&amp;code=cert_material" target="_blank" title="实体店铺"><img src="<?php echo $this->res_base . "/" . 'images/cert_material.gif'; ?>" /></a>
                        <?php endif; ?>
        ...
        <div class="module_common">
            ...
            <div class="wrap">
                <div class="wrap_child">
                    <ul class="submenu">
                        <li><a class="none_ico" href="index.php?app=store&amp;id=<?php echo $this->_var['store']['store_id']; ?>&amp;act=search">全部商品</a></li>
