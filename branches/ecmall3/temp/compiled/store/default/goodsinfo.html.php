...
?>
    ...
    <div class="ware_text">
        <div class="rate">
            ...
            <span class="letter1">品牌: </span><?php echo $this->_var['goods']['brand']; ?><br />
            销售情况: <?php echo $this->_var['sales_info']; ?><?php echo $this->_var['comments']; ?><br />
            所在地区: <?php echo $this->_var['store']['region_name']; ?>
        </div>
                ...
                <div class="ware_center">
                    ...
                    <div class="ware_cen_btn">
                        ...
                        <p class="ware_text_btn">
                            <input type="submit" class="btn1" name="" value="查看购物车" onclick="location.href='index.php?app=cart'" />
