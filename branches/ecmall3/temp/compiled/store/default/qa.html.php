...
?>
    <div class="<?php echo $this->cycle(array('values'=>'message_text2,message_text2 bg1')); ?>">
        <dl class="leave_word">
            ...
            <p>
                <span class="name"><?php if ($this->_var['qainfo']['user_name']): ?><?php echo $this->_var['qainfo']['user_name']; ?><?php else: ?>游客<?php endif; ?> <?php echo local_date("Y-m-d H:i:s",$this->_var['qainfo']['time_post']); ?></span>
            </p>
        </dl>
