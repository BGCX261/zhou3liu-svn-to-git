        ...
        <div class="wrap_line margin1">
            <div class="public">
                <div class="information_index">
                    ...
                    <div class="info">
                        <h3 class="margin2">
                            <span>欢迎您，<?php echo $this->_var['user']['user_name']; ?></span>
                            <a href="index.php?app=member&amp;act=profile">编辑个人资料>></a>
                        </h3>
                        <table class="width6">
                            <tr>
                                ...
                                卖家信用: <a href="index.php?app=store&amp;act=credit&amp;id=<?php echo $this->_var['store']['store_id']; ?>" target="_blank"><?php echo $this->_var['store']['credit_value']; ?></a> <img src="<?php echo $this->_var['store']['credit_image']; ?>" />
                                <?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <p><?php echo sprintf('您有 <span class="red">%s</span> 条短消息，<a href="index.php?app=message&act=inbox">点击查看</a>', $this->_var['new_message']['total']); ?></p>
                    </div>
                </div>
            ...
            <div class="public_index">
                <div class="information_index">
                    ...
                    <div class="remind">
                        ...
                        <a href="index.php?app=buyer_order" class="btn pos1" title="查看我的订单"><span class="pic1">查看我的订单</span></a>
                    </div>
                    <?php else: ?>
                    <div class="awoke">
            ...
            <div class="public_index">
                <div class="information_index">
                    ...
                    <div class="remind">
                        ...
                        <a href="index.php?app=store&id=<?php echo $this->_var['store']['store_id']; ?>" title="查看我的店铺" target="_blank" class="btn1 pos2"><span class="pic2">查看我的店铺</span></a>
