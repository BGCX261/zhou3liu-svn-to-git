...
?>
                            ...
                            <li><a href="###" id="<?php echo $this->_var['category']['cate_id']; ?>"><?php echo htmlspecialchars($this->_var['category']['cate_name']); ?></a></li>
                            <?php else: ?>
                            <li style="display:none"><a href="###" id="<?php echo $this->_var['category']['cate_id']; ?>"><?php echo htmlspecialchars($this->_var['category']['cate_name']); ?></a></li>
                            <?php endif; ?>
...
?>
                            ...
                            <li><a href="###" title="<?php echo $this->_var['row']['brand']; ?>"><?php echo $this->_var['row']['brand']; ?></a> (<?php echo $this->_var['row']['count']; ?>)</li>
                            <?php else: ?>
                            <li style="display:none"><a href="###" title="<?php echo $this->_var['row']['brand']; ?>"><?php echo $this->_var['row']['brand']; ?></a> (<?php echo $this->_var['row']['count']; ?>)</li>
                            <?php endif; ?>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </ul>
                    </div>
    ...
    foreach ($_from AS $this->_var['row']):
?>
                            <li><a href="###" title="<?php echo $this->_var['row']['min']; ?> - <?php echo $this->_var['row']['max']; ?>"><?php echo price_format($this->_var['row']['min']); ?> - <?php echo price_format($this->_var['row']['max']); ?></a> (<?php echo $this->_var['row']['count']; ?>)</li>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
                            ...
                            <li><a href="###" title="<?php echo $this->_var['row']['region_id']; ?>"><?php echo $this->_var['row']['region_name']; ?></a> (<?php echo $this->_var['row']['count']; ?>)</li>
                            <?php else: ?>
                            <li style="display:none"><a href="###" title="<?php echo $this->_var['row']['region_id']; ?>"><?php echo $this->_var['row']['region_name']; ?></a> (<?php echo $this->_var['row']['count']; ?>)</li>
                            <?php endif; ?>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </ul>
                    </div>
...
?>
                    ...
                    <li class="normal" ectype="dropdown_filter_title" ecvalue="brand">
                        <span class="txt">品牌: <a href="#">请选择</a></span>
                    ...
                    <li class="normal" ectype="dropdown_filter_title" ecvalue="price">
                        <span class="txt">价格: <a href="#">请选择</a></span>
                        <span class="ico"><img src="<?php echo $this->res_base . "/" . 'images/down.gif'; ?>" /></span>
                    </li>
                    <?php if (! $this->_var['filters']['region_id']): ?>
                    <li class="normal" ectype="dropdown_filter_title" ecvalue="region">
                        <span class="txt">所在地区: <a href="#">请选择</a></span>
                        <span class="ico"><img src="<?php echo $this->res_base . "/" . 'images/down.gif'; ?>" /></span>
                    </li>
                    <?php endif; ?>
                </ul>
    ...
    foreach ($_from AS $this->_var['row']):
?>
                        <li><a href="###" title="<?php echo $this->_var['row']['brand']; ?>"><?php echo $this->_var['row']['brand']; ?> (<?php echo $this->_var['row']['count']; ?>)</a></li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                </div>
                <?php endif; ?>
    ...
    foreach ($_from AS $this->_var['row']):
?>
                        <li><a href="###" title="<?php echo $this->_var['row']['min']; ?> - <?php echo $this->_var['row']['max']; ?>"><?php echo price_format($this->_var['row']['min']); ?> - <?php echo price_format($this->_var['row']['max']); ?> (<?php echo $this->_var['row']['count']; ?>)</a></li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                </div>
                <?php if (! $this->_var['filters']['region_id']): ?>
    ...
    foreach ($_from AS $this->_var['row']):
?>
                        <li><a href="###" title="<?php echo $this->_var['row']['region_id']; ?>"><?php echo $this->_var['row']['region_name']; ?> (<?php echo $this->_var['row']['count']; ?>)</a></li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                </div>
                <?php endif; ?>
...
?>
                    <li>
                        <p><a href="index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['default_image']; ?>" /></a></p>
                        <h3>
                            <span class="text_link">
                                <span class="depict">
                                    <a href="index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a>
                                </span>
                                <span class="info">
                            ...
                            <b>已售: <?php echo ($this->_var['goods']['sales'] == '') ? '0' : $this->_var['goods']['sales']; ?> 件 | <a href="index.php?app=goods&amp;act=comments&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><?php echo ($this->_var['goods']['comments'] == '') ? '0' : $this->_var['goods']['comments']; ?> 评论</a></b>
                        </h3>
                    </li>
                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
