            ...
            <div class="wrap_child">
                <div class="login_con">
                        ...
                        <table>
                            ...
                            <tr class="distance">
                                ...
                                <td>
                                  ...
                                  <a href="index.php?app=find_password" class="clew">忘记密码？</a>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="login_right">
                        ...
                        <a href="index.php?app=member&amp;act=register&amp;ret_url=<?php echo $this->_var['ret_url']; ?>" class="login_btn" title="立即注册"></a>
                    </div>
                </div>
            </div>
        </div>
