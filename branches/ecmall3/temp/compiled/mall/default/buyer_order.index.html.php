            ...
            <div class="public">
                ...
                <form method="get">
                    <?php if ($this->_var['query']['seller_name'] || $this->_var['query']['add_time_from'] || $this->_var['query']['add_time_to'] || $this->_var['query']['order_sn']): ?>
                     <a class="detlink float_right" href="index.php?app=buyer_order">取消检索</a>
                    <?php endif; ?>
                    <span>下单时间: </span>
...
?>
                <div class="order_form">
                    <h2>
                        <p class="num">订单号: <?php echo $this->_var['order']['order_sn']; ?></p>
...
?>
                    ...
                    <div class="foot">
                        ...
                        <p class="defray">支付方式: <?php echo $this->_var['order']['payment_name']; ?></p>
                        <?php endif; ?>
                        <div class="handle">
                            ...
                            <a href="index.php?app=cashier&amp;order_id=<?php echo $this->_var['order']['order_id']; ?>" target="_blank" id="order<?php echo $this->_var['order']['order_id']; ?>_action_pay"<?php if ($this->_var['order']['status'] != ORDER_PENDING): ?> style="display:none"<?php endif; ?> class="btn">付款</a>
                            ...
                            <a href="index.php?app=buyer_order&amp;act=view&amp;order_id=<?php echo $this->_var['order']['order_id']; ?>" target="_blank" class="btn1">查看订单</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; else: ?>
