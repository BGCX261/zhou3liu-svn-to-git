...
?>
                    <tr class="bgcolor line_normal">
                        ...
                        <td><a href="index.php?app=goods&amp;id=<?php echo $this->_var['my_qa_list']['goods_id']; ?>&amp;act=qa&amp;question_id=<?php echo $this->_var['my_qa_list']['ques_id']; ?>&amp;new=yes" target="_blank" class="link3"><?php echo $this->_var['my_qa_list']['goods_name']; ?></a></td>
                        <td class="width8">
                            <span class="table_user"><?php if ($this->_var['my_qa_list']['user_name'] != ''): ?><?php echo $this->_var['my_qa_list']['user_name']; ?><?php else: ?>游客<?php endif; ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                    ...
                    <tr <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?>class="line_bold"<?php endif; ?>>
                        ...
                        <td>
                            ...
                            <p><span class="color3"><?php echo $this->_var['my_qa_list']['reply_content']; ?></span></p>
                        </td>
