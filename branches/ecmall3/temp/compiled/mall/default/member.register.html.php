            ...
            <div class="wrap_child">
                <div class="login_con">
                    <div class="login_fill_in">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="padding3 fontColor4"><label class="field_notice">请输入一个有效的E-mail地址</label></td>
                            </tr>
                            ...
                            <tr>
                                <td></td>
                                <td><input id="clause" type="checkbox" name="agree" value="1" /> <label for="clause">我已阅读并同意 <a href="index.php?app=article&act=system&code=eula" target="_blank" class="agreement">用户服务协议</a></label></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td></td>
                    ...
                    <div class="login_right">
                        ...
                        <h4>已经拥有账号</h4>
                        <a href="index.php?app=member&act=login&ret_url=<?php echo $this->_var['ret_url']; ?>" class="enter" title="立即登录"></a>
                    </div>
                </div>
            </div>
        </div>
