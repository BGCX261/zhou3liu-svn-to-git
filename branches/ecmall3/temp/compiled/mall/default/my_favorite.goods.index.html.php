                ...
                <table>
                    ...
                    <tr class="line_bold">
                        ...
                        <th class="align1" colspan="6">
                            ...
                            <a href="###" class="delete" uri="index.php?app=my_favorite&act=drop&type=goods" name="item_id" presubmit="confirm('您确定要删除它吗？')" ectype="batchbutton">删除</a>
                        </th>
                    </tr>
                    <?php endif; ?>
...
?>
                    <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?><tr class="line_bold"><?php else: ?><tr class="line"><?php endif; ?>
                        ...
                        <td>
                            <p class="ware_pic"><a href="index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['default_image']; ?>" width="50" height="50"  /></a></p>
                        </td>
                        <td>
                            <p class="ware_text"><a href="index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><?php echo $this->_var['goods']['goods_name']; ?></a></p>
                        </td>
                        <td class="width3"><?php echo $this->_var['goods']['store_name']; ?></td>
                        <td class="width2"><a target="_blank" href="index.php?app=message&act=send&to_id=<?php echo $this->_var['goods']['store_id']; ?>" class="email" title="发站内信"></a></td>
